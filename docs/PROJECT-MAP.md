...
> Обновлено 2026-06-12. Один файл — одна строка. Генерированные файлы (`*.g.dart`,
...
| `START.md` | Быстрый старт: как запустить бэкенд/приложение/тесты, указатель по докам |
...
| `BOARD.md` | Статус-борд: что сделано/в работе по блокам, фидбек ревью |
| `AUDIT.md` | Аудит: выполнено/в разработке/не начато/баги/техдолг |
| `PROJECT-MAP.md` | Этот файл |
| `SETUP-IDE.md` | Как открыть проект в другой IDE: SDK, расширения, команды, промт продолжения |
| `agents/*-tasks.md` | Детальные задачи по ролям (backend/flutter/ai/qa) — исторические чек-листы |

...
const Map<String, Map<String, String>> healthBStrings = {
  ...
  'screentime.usage_coming_soon': {
    ...
    'fr': 'Les données d\'utilisation nécessitent des autorisations système non disponibles. Bientôt.',
    'it': 'I dati di utilizzo richiedono permessi di sistema non ancora disponibili. Presto.',
    'pt': 'Os dados de uso requerem permissões do sistema ainda não disponíveis. Em breve.',
    'es': 'Los datos de uso requieren permisos del sistema aún no disponibles. Próximamente.',
    'id': 'Data penggunaan memerlukan izin sistem yang belum tersedia. Segera hadir.',
    'hi': 'उपयोग डेटा के लिए सिस्टम अनुमति आवश्यक है जो अभी उपलब्ध नहीं है। जल्द आ रहा है।',
    'ja': '利用データにはまだ利用できないシステム権限が必要です。近日公開。',
    'ko': '사용 데이터는 아직 지원되지 않는 시스템 권한이 필요합니다. 곧 제공됩니다.',
  },
  'screentime.tips': {
    'en': 'Tips',
    'ru': 'Советы',
